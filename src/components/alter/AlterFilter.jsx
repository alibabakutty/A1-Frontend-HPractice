        ...
        const handleKeyDown = e => {
            if (e.key === 'ArrowDown'){
                ...
                if (selectedIndex === 0){
                    ...
                    navigate(`/voucherTypeMasterApi/alterVoucherTypeMaster/${preDefinedVoucherTypeSuggestions[selectedIndex - voucherTypeSuggestion.length - 2].value}`);
                }
                            ...
                            {type === 'voucher' && (
                                <ul className=''>
                                    {preDefinedVoucherTypeSuggestions.map((voucher,index) => (
                                        ...
                                        >
                                            <Link to={`/voucherTypeMasterApi/alterVoucherTypeMaster/${voucher.value}`}>{voucher.value}</Link>
                                        </li>
                                    ))}
                                </ul>
                            )}
